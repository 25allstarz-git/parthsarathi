  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <p className="font-mono text-xs tracking-[0.2em] text-gold uppercase">ParthSarathi</p>
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This record or page is not available. It may have been moved, closed, or is outside your
          access permissions.
        </p>
        <div className="mt-6">
          <Link
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Something went wrong while retrieving this record. You can retry or return home.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { title: "ParthSarathi — AI-assisted access to the courts" },
      {
        name: "description",
        content:
          "ParthSarathi connects citizens, lawyers, judicial officers and law enforcement with AI-assisted case understanding, document analysis and cause lists.",
      },
