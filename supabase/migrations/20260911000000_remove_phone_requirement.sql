-- Replace the register_role function to remove the requirement for a verified phone number
-- since we are moving to Google OAuth for citizens.
...
BEGIN
  ...
  IF _role = 'citizen' THEN
    -- No longer requiring phone_confirmed_at
    _status := 'verified';
